...
CREW_PREFIX=${CREW_PREFIX:-/usr/local/crew}
...
"aarch64")
  ...
  urls+=('https://dl.bintray.com/chromebrew/chromebrew/git-2.17.0-chromeos-armv7l.tar.xz')
  sha256s+=('2344502e10a3e8d9054e5769b9781640d455288914f517f9bc1e669050d13703')
...
"i686")
  ...
  urls+=('https://dl.bintray.com/chromebrew/chromebrew/git-2.17.0-chromeos-i686.tar.xz')
  sha256s+=('127385a0b9d0f6e2f14b96cd649f38a3af18f02689685cd06b2eb8b35a6134df')
...
"x86_64")
  ...
  urls+=('https://dl.bintray.com/chromebrew/chromebrew/git-2.17.0-chromeos-x86_64.tar.xz')
  sha256s+=('fddf194fcafc443968343f19f20561b71faedf93e43b0db52c180144e4457145')
